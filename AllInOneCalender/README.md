...
## Features
- Calendar-first home screen with a square day grid that shows up to four tasks directly in each date cell plus a built-in [+] tile (five total slots) for quick adds.
